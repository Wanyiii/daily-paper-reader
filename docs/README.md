...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-11 22:03:06 UTC<br>状态：成功</p>
</section>
...
<p>今日共生成 25 篇推荐（精读 12 篇，速读 13 篇）</p>
<p>精读：《SeqLoc: Beyond the Single Frame for Cross-View Geo-Localization in Feature-Sparse Scenes》（10.0/10）, 《FlexSplat: Flexible Feed-Forward 3D Gaussian Splatting without Point Cloud Correspondence》（9.0/10）</p>
<p>速读：《GST-Bench: Can VLMs Develop Global Spatial Awareness from Video?》（8.0/10）, 《LMM Modality Transfer: A Pre-requisite for Autonomous GIS Agents》（8.0/10）, 《InstanceSplat: Instance-Aware Feed-Forward 3D Gaussian Splatting for Scene Understanding》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SeqLoc: Beyond the Single Frame for Cross-View Geo-Localization in Feature-Sparse Scenes">SeqLoc: Beyond the Single Frame for Cross-View Geo-Localization in Feature-Sparse Scenes</span></li><li><span class="dpr-home-dashboard-paper-title" title="FlexSplat: Flexible Feed-Forward 3D Gaussian Splatting without Point Cloud Correspondence">FlexSplat: Flexible Feed-Forward 3D Gaussian Splatting without Point Cloud Correspondence</span></li><li><span class="dpr-home-dashboard-paper-title" title="Self-Evolving Neuro-Symbolic Skills for Tool-Augmented Spatial Reasoning">Self-Evolving Neuro-Symbolic Skills for Tool-Augmented Spatial Reasoning</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">d-vision <strong>9</strong></span><span class="dpr-home-dashboard-tag">mgl <strong>2</strong></span><span class="dpr-home-dashboard-tag">multimodal <strong>1</strong></span></div>
</section>
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="GST-Bench: Can VLMs Develop Global Spatial Awareness from Video?">GST-Bench: Can VLMs Develop Global Spatial Awareness from Video?</span></li><li><span class="dpr-home-dashboard-paper-title" title="LMM Modality Transfer: A Pre-requisite for Autonomous GIS Agents">LMM Modality Transfer: A Pre-requisite for Autonomous GIS Agents</span></li><li><span class="dpr-home-dashboard-paper-title" title="InstanceSplat: Instance-Aware Feed-Forward 3D Gaussian Splatting for Scene Understanding">InstanceSplat: Instance-Aware Feed-Forward 3D Gaussian Splatting for Scene Understanding</span></li></ul>
  </div>
