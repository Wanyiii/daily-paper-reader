...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-12 22:16:08 UTC<br>状态：成功</p>
</section>
...
<p>精读：《Compositional Cross-Modality Translation via Whole-Volume Multitask Latent Flow Matching》（8.0/10）, 《SraVaani 1.0: Scaling Inclusive Speech Recognition for Indic Languages》（8.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Compositional Cross-Modality Translation via Whole-Volume Multitask Latent Flow Matching">Compositional Cross-Modality Translation via Whole-Volume Multitask Latent Flow Matching</span></li><li><span class="dpr-home-dashboard-paper-title" title="SraVaani 1.0: Scaling Inclusive Speech Recognition for Indic Languages">SraVaani 1.0: Scaling Inclusive Speech Recognition for Indic Languages</span></li><li><span class="dpr-home-dashboard-paper-title" title="Frequency-Domain Dual-Branch Fusion for Medical Visual Question Answering">Frequency-Domain Dual-Branch Fusion for Medical Visual Question Answering</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">multimodal <strong>5</strong></span></div>
</section>
